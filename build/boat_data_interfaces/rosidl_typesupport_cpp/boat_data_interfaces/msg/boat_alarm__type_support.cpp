...
static const _BoatAlarm_type_support_symbol_names_t _BoatAlarm_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, boat_data_interfaces, msg, BoatAlarm)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, boat_data_interfaces, msg, BoatAlarm)),
  }
};
...
{
  return &::boat_data_interfaces::msg::rosidl_typesupport_cpp::BoatAlarm_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, boat_data_interfaces, msg, BoatAlarm)() {
  return get_message_type_support_handle<boat_data_interfaces::msg::BoatAlarm>();
}
