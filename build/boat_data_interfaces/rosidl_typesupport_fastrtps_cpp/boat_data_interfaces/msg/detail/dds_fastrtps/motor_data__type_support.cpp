...
#include "boat_data_interfaces/msg/detail/motor_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = boat_data_interfaces::msg::MotorData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const boat_data_interfaces::msg::MotorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<boat_data_interfaces::msg::MotorData *>(
    untyped_ros_message);
...
{
  return &boat_data_interfaces::msg::typesupport_fastrtps_cpp::_MotorData__handle;
}
