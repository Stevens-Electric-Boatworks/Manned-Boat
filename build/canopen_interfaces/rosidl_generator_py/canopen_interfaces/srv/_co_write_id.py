...
class Metaclass_COWriteID_Event(type):
    """Metaclass of message 'COWriteID_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__co_write_id__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__co_write_id__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__co_write_id__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__co_write_id__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__co_write_id__event
...
class COWriteID_Event(metaclass=Metaclass_COWriteID_Event):
    """Message class 'COWriteID_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<canopen_interfaces/COWriteID_Request, 1>',
        'response': 'sequence<canopen_interfaces/COWriteID_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['canopen_interfaces', 'srv'], 'COWriteID_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['canopen_interfaces', 'srv'], 'COWriteID_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from canopen_interfaces.srv import COWriteID_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, COWriteID_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'COWriteID_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from canopen_interfaces.srv import COWriteID_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, COWriteID_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'COWriteID_Response'"
...
class Metaclass_COWriteID(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _co_write_id.Metaclass_COWriteID_Event._TYPE_SUPPORT is None:
                _co_write_id.Metaclass_COWriteID_Event.__import_type_support__()
...
class COWriteID(metaclass=Metaclass_COWriteID):
    ...
    from canopen_interfaces.srv._co_write_id import COWriteID_Event as Event
