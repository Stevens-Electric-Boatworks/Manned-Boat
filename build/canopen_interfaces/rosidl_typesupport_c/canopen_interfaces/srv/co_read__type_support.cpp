...
static const _CORead_Event_type_support_symbol_names_t _CORead_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, canopen_interfaces, srv, CORead_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, canopen_interfaces, srv, CORead_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, canopen_interfaces, srv, CORead_Event)() {
  return &::canopen_interfaces::srv::rosidl_typesupport_c::CORead_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t CORead_service_type_support_handle = {
  ...
  &CORead_Request_message_type_support_handle,
  &CORead_Response_message_type_support_handle,
  &CORead_Event_message_type_support_handle,
