...
static const _COWriteID_Event_type_support_symbol_names_t _COWriteID_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, canopen_interfaces, srv, COWriteID_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, canopen_interfaces, srv, COWriteID_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, canopen_interfaces, srv, COWriteID_Event)() {
  return &::canopen_interfaces::srv::rosidl_typesupport_c::COWriteID_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t COWriteID_service_type_support_handle = {
  ...
  &COWriteID_Request_message_type_support_handle,
  &COWriteID_Response_message_type_support_handle,
  &COWriteID_Event_message_type_support_handle,
