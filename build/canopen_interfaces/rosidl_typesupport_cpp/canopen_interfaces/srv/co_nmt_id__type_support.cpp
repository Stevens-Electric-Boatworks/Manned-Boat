...
static const _CONmtID_Event_type_support_symbol_names_t _CONmtID_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, canopen_interfaces, srv, CONmtID_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, canopen_interfaces, srv, CONmtID_Event)),
  }
};
...
{
  return &::canopen_interfaces::srv::rosidl_typesupport_cpp::CONmtID_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, canopen_interfaces, srv, CONmtID_Event)() {
  return get_message_type_support_handle<canopen_interfaces::srv::CONmtID_Event>();
}
...
static const rosidl_service_type_support_t CONmtID_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<canopen_interfaces::srv::CONmtID_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<canopen_interfaces::srv::CONmtID_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<canopen_interfaces::srv::CONmtID_Event>(),
