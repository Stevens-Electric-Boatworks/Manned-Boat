...
typedef struct _CONode_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _CONode_Event_type_support_ids_t;

static const _CONode_Event_type_support_ids_t _CONode_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _CONode_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _CONode_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _CONode_Event_type_support_symbol_names_t _CONode_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, canopen_interfaces, srv, CONode_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, canopen_interfaces, srv, CONode_Event)),
  }
};

typedef struct _CONode_Event_type_support_data_t
{
  void * data[2];
} _CONode_Event_type_support_data_t;

static _CONode_Event_type_support_data_t _CONode_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _CONode_Event_message_typesupport_map = {
  2,
  "canopen_interfaces",
  &_CONode_Event_message_typesupport_ids.typesupport_identifier[0],
  &_CONode_Event_message_typesupport_symbol_names.symbol_name[0],
  &_CONode_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t CONode_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_CONode_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::canopen_interfaces::srv::rosidl_typesupport_cpp::CONode_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, canopen_interfaces, srv, CONode_Event)() {
  return get_message_type_support_handle<canopen_interfaces::srv::CONode_Event>();
}
...
static const rosidl_service_type_support_t CONode_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<canopen_interfaces::srv::CONode_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<canopen_interfaces::srv::CONode_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<canopen_interfaces::srv::CONode_Event>(),
