...
static const _COTargetDouble_Event_type_support_symbol_names_t _COTargetDouble_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, canopen_interfaces, srv, COTargetDouble_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, canopen_interfaces, srv, COTargetDouble_Event)),
  }
};
...
{
  return &::canopen_interfaces::srv::rosidl_typesupport_cpp::COTargetDouble_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, canopen_interfaces, srv, COTargetDouble_Event)() {
  return get_message_type_support_handle<canopen_interfaces::srv::COTargetDouble_Event>();
}
...
static const rosidl_service_type_support_t COTargetDouble_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<canopen_interfaces::srv::COTargetDouble_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<canopen_interfaces::srv::COTargetDouble_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<canopen_interfaces::srv::COTargetDouble_Event>(),
