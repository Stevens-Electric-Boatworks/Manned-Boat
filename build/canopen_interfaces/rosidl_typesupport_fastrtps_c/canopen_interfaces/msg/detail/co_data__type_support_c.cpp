...
bool cdr_serialize_canopen_interfaces__msg__COData(
  const canopen_interfaces__msg__COData * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_canopen_interfaces
bool cdr_deserialize_canopen_interfaces__msg__COData(
  eprosima::fastcdr::Cdr & cdr,
  canopen_interfaces__msg__COData * ros_message)
{
  // Field name: index
  {
    cdr >> ros_message->index;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_canopen_interfaces
bool cdr_serialize_key_canopen_interfaces__msg__COData(
  const canopen_interfaces__msg__COData * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: index
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_canopen_interfaces
size_t get_serialized_size_key_canopen_interfaces__msg__COData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _COData__ros_msg_type * ros_message = static_cast<const _COData__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_canopen_interfaces
size_t max_serialized_size_key_canopen_interfaces__msg__COData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const canopen_interfaces__msg__COData * ros_message = static_cast<const canopen_interfaces__msg__COData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_canopen_interfaces__msg__COData(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  canopen_interfaces__msg__COData * ros_message = static_cast<canopen_interfaces__msg__COData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_canopen_interfaces__msg__COData(cdr, ros_message);
}
