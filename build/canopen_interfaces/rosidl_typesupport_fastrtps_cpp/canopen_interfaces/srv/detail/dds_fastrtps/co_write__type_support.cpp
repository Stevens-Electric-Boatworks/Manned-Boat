...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_canopen_interfaces
max_serialized_size_key_COWrite_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_canopen_interfaces
max_serialized_size_key_COWrite_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
// functions for canopen_interfaces::srv::COWrite_Request already declared above

// functions for canopen_interfaces::srv::COWrite_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_canopen_interfaces
cdr_serialize(
  const canopen_interfaces::srv::COWrite_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  canopen_interfaces::srv::COWrite_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_canopen_interfaces
max_serialized_size_COWrite_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        canopen_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_COWrite_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        canopen_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_COWrite_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = canopen_interfaces::srv::COWrite_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_canopen_interfaces
max_serialized_size_key_COWrite_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        canopen_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_COWrite_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        canopen_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_COWrite_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const canopen_interfaces::srv::COWrite_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<canopen_interfaces::srv::COWrite_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _COWrite_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const canopen_interfaces::srv::COWrite_Event *>(
...
static size_t _COWrite_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_COWrite_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _COWrite_Event__callbacks = {
  "canopen_interfaces::srv",
  "COWrite_Event",
...
static rosidl_message_type_support_t _COWrite_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_COWrite_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &canopen_interfaces::srv::typesupport_fastrtps_cpp::_COWrite_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, canopen_interfaces, srv, COWrite_Event)() {
  return &canopen_interfaces::srv::typesupport_fastrtps_cpp::_COWrite_Event__handle;
}
...
static const rosidl_service_type_support_t _COWrite__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_COWrite__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<canopen_interfaces::srv::COWrite_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<canopen_interfaces::srv::COWrite_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<canopen_interfaces::srv::COWrite_Event>(),
