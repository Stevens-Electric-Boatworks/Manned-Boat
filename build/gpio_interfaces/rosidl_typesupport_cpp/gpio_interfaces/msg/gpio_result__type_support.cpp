...
static const _GPIOResult_type_support_symbol_names_t _GPIOResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpio_interfaces, msg, GPIOResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpio_interfaces, msg, GPIOResult)),
  }
};
...
{
  return &::gpio_interfaces::msg::rosidl_typesupport_cpp::GPIOResult_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gpio_interfaces, msg, GPIOResult)() {
  return get_message_type_support_handle<gpio_interfaces::msg::GPIOResult>();
}
