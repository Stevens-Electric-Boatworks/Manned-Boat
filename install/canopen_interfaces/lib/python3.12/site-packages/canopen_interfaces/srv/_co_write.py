...
class Metaclass_COWrite_Event(type):
    """Metaclass of message 'COWrite_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__co_write__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__co_write__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__co_write__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__co_write__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__co_write__event
...
class COWrite_Event(metaclass=Metaclass_COWrite_Event):
    """Message class 'COWrite_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<canopen_interfaces/COWrite_Request, 1>',
        'response': 'sequence<canopen_interfaces/COWrite_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['canopen_interfaces', 'srv'], 'COWrite_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['canopen_interfaces', 'srv'], 'COWrite_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from canopen_interfaces.srv import COWrite_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, COWrite_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'COWrite_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from canopen_interfaces.srv import COWrite_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, COWrite_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'COWrite_Response'"
...
class Metaclass_COWrite(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _co_write.Metaclass_COWrite_Event._TYPE_SUPPORT is None:
                _co_write.Metaclass_COWrite_Event.__import_type_support__()
...
class COWrite(metaclass=Metaclass_COWrite):
    ...
    from canopen_interfaces.srv._co_write import COWrite_Event as Event
