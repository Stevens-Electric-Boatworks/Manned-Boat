...
class Metaclass_GPIOResult(type):
    """Metaclass of message 'GPIOResult'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('gpio_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'gpio_interfaces.msg.GPIOResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__gpio_result
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__gpio_result
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__gpio_result
            cls._TYPE_SUPPORT = module.type_support_msg__msg__gpio_result
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__gpio_result
...
class GPIOResult(metaclass=Metaclass_GPIOResult):
    """Message class 'GPIOResult'."""
    ...
    def gps_lon(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'gps_lon' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._gps_lon = value
