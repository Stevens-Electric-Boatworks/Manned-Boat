...
enum
{
  canopen_interfaces__srv__CONmtID_Event__request__MAX_SIZE = 1
};
// response
enum
{
  canopen_interfaces__srv__CONmtID_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/CONmtID in the package canopen_interfaces.
typedef struct canopen_interfaces__srv__CONmtID_Event
{
  service_msgs__msg__ServiceEventInfo info;
  canopen_interfaces__srv__CONmtID_Request__Sequence request;
  canopen_interfaces__srv__CONmtID_Response__Sequence response;
} canopen_interfaces__srv__CONmtID_Event;

// Struct for a sequence of canopen_interfaces__srv__CONmtID_Event.
typedef struct canopen_interfaces__srv__CONmtID_Event__Sequence
{
