...
inline std::string to_yaml(const CONmtID_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use canopen_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const canopen_interfaces::srv::CONmtID_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  canopen_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use canopen_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const canopen_interfaces::srv::CONmtID_Event & msg)
{
  return canopen_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<canopen_interfaces::srv::CONmtID_Event>()
{
  return "canopen_interfaces::srv::CONmtID_Event";
}

template<>
inline const char * name<canopen_interfaces::srv::CONmtID_Event>()
{
  return "canopen_interfaces/srv/CONmtID_Event";
}

template<>
struct has_fixed_size<canopen_interfaces::srv::CONmtID_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<canopen_interfaces::srv::CONmtID_Event>
  : std::integral_constant<bool, has_bounded_size<canopen_interfaces::srv::CONmtID_Request>::value && has_bounded_size<canopen_interfaces::srv::CONmtID_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<canopen_interfaces::srv::CONmtID_Event>
  : std::true_type {};
