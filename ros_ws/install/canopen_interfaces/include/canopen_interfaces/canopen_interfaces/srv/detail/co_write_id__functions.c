...
canopen_interfaces__srv__COWriteID_Request__create(void)
{
...
canopen_interfaces__srv__COWriteID_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
canopen_interfaces__srv__COWriteID_Event__init(canopen_interfaces__srv__COWriteID_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    canopen_interfaces__srv__COWriteID_Event__fini(msg);
    return false;
  }
  // request
  if (!canopen_interfaces__srv__COWriteID_Request__Sequence__init(&msg->request, 0)) {
    canopen_interfaces__srv__COWriteID_Event__fini(msg);
    return false;
  }
  // response
  if (!canopen_interfaces__srv__COWriteID_Response__Sequence__init(&msg->response, 0)) {
    canopen_interfaces__srv__COWriteID_Event__fini(msg);
    return false;
  }
  return true;
...
void
canopen_interfaces__srv__COWriteID_Event__fini(canopen_interfaces__srv__COWriteID_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  canopen_interfaces__srv__COWriteID_Request__Sequence__fini(&msg->request);
  // response
  canopen_interfaces__srv__COWriteID_Response__Sequence__fini(&msg->response);
}

bool
canopen_interfaces__srv__COWriteID_Event__are_equal(const canopen_interfaces__srv__COWriteID_Event * lhs, const canopen_interfaces__srv__COWriteID_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!canopen_interfaces__srv__COWriteID_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!canopen_interfaces__srv__COWriteID_Response__Sequence__are_equal(
...
bool
canopen_interfaces__srv__COWriteID_Event__copy(
  const canopen_interfaces__srv__COWriteID_Event * input,
  canopen_interfaces__srv__COWriteID_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!canopen_interfaces__srv__COWriteID_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!canopen_interfaces__srv__COWriteID_Response__Sequence__copy(
...
canopen_interfaces__srv__COWriteID_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  canopen_interfaces__srv__COWriteID_Event * msg = (canopen_interfaces__srv__COWriteID_Event *)allocator.allocate(sizeof(canopen_interfaces__srv__COWriteID_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(canopen_interfaces__srv__COWriteID_Event));
  bool success = canopen_interfaces__srv__COWriteID_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
canopen_interfaces__srv__COWriteID_Event__destroy(canopen_interfaces__srv__COWriteID_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    canopen_interfaces__srv__COWriteID_Event__fini(msg);
...
bool
canopen_interfaces__srv__COWriteID_Event__Sequence__init(canopen_interfaces__srv__COWriteID_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  canopen_interfaces__srv__COWriteID_Event * data = NULL;

  if (size) {
    data = (canopen_interfaces__srv__COWriteID_Event *)allocator.zero_allocate(size, sizeof(canopen_interfaces__srv__COWriteID_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = canopen_interfaces__srv__COWriteID_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        canopen_interfaces__srv__COWriteID_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
canopen_interfaces__srv__COWriteID_Event__Sequence__fini(canopen_interfaces__srv__COWriteID_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      canopen_interfaces__srv__COWriteID_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
canopen_interfaces__srv__COWriteID_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  canopen_interfaces__srv__COWriteID_Event__Sequence * array = (canopen_interfaces__srv__COWriteID_Event__Sequence *)allocator.allocate(sizeof(canopen_interfaces__srv__COWriteID_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = canopen_interfaces__srv__COWriteID_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
canopen_interfaces__srv__COWriteID_Event__Sequence__destroy(canopen_interfaces__srv__COWriteID_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    canopen_interfaces__srv__COWriteID_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
canopen_interfaces__srv__COWriteID_Event__Sequence__are_equal(const canopen_interfaces__srv__COWriteID_Event__Sequence * lhs, const canopen_interfaces__srv__COWriteID_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!canopen_interfaces__srv__COWriteID_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
canopen_interfaces__srv__COWriteID_Event__Sequence__copy(
  const canopen_interfaces__srv__COWriteID_Event__Sequence * input,
  canopen_interfaces__srv__COWriteID_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(canopen_interfaces__srv__COWriteID_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    canopen_interfaces__srv__COWriteID_Event * data =
      (canopen_interfaces__srv__COWriteID_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!canopen_interfaces__srv__COWriteID_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          canopen_interfaces__srv__COWriteID_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!canopen_interfaces__srv__COWriteID_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
