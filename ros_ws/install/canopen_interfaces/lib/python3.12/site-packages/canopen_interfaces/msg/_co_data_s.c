...
bool canopen_interfaces__msg__co_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("canopen_interfaces.msg._co_data", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("COData", (char *)PyUnicode_1BYTE_DATA(name_attr), 6) == 0);
