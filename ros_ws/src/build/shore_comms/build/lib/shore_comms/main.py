...
class ShoreDataCollector(Node):
    ...
    def __init__(self):
       ...
       # self.create_sub(BoatAlarm, "/all_alarms", self.alarms_collector)
        ...
        self.get_logger().info("AAAdfasfdasfkjhasdkflhaskjfhsakjfhddakjfhaklsjf")
        
        self._logger.info("[Websocket Watchdog] Starting timer...")
    ...
    def watchdog_callback(self):
        ...
        if self.websocket is None:
            self._logger.debug("[Websocket Watchdog] Websocket is not opened yet...")
            return
    ...
    def alarms_collector(self, msg:BoatAlarm):
        self.addAlarm(msg.error_code, msg.timestamp.sec)
