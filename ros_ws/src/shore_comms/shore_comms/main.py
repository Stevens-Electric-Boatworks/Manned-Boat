...
class ShoreDataCollector(Node):
    ...
    def gpioCollector(self, data:GPIOResult):
        ...
        self.addData("imu_x", data.imu_x)
        self.addData("imu_y", data.imu_y)
        self.addData("imu_z", data.imu_z)
        self.addData("gps_lat", data.gps_lat)
        self.addData("gps_long", data.gps_long)
        self.addData("gps_alt", data.gps_alt)
